    ...
    return L.divIcon({{
      ...
      ">
        <img src="${{d.foto}}" style="width:100%;height:100%;object-fit:cover;"
          onerror="this.parentElement.innerHTML='<div style=text-align:center;line-height:26px;font-size:14px>⌂</div>'">
        ${{d.novo ? '<div style="position:absolute;top:0;right:0;width:8px;height:8px;background:#f43f5e;border-radius:50%;border:1px solid white"></div>' : ''}}
      </div>`,
      iconSize: [30,30],
      iconAnchor: [15,15],
      popupAnchor: [0,-18],
